...
const demoCircleClass = 'size-10 rounded-[50%] border border-(--pill-border) bg-(--pill-bg) text-(--pill-fg) shadow-(--pill-shadow) cursor-pointer flex items-center justify-center p-0';
  ...
  return (
    <section className="w-full flex flex-col gap-3 mb-12" aria-label="Effect demonstrations">
      ...
      <div className="relative w-full h-[314px] rounded-[30px] bg-(--surface) flex items-center justify-center px-10 py-12 overflow-hidden max-sm:h-auto max-sm:min-h-[200px] max-sm:px-5 max-sm:py-8 max-sm:rounded-[20px]">
        <div className="w-[448px] max-w-full rounded-[20px] bg-(--mock-chat-bg) shadow-(--mock-chat-shadow) pt-5 px-4 pb-4 flex flex-col max-sm:w-full">
          <textarea
      ...
      {/* Toolbar row */}
      <div className="relative w-full h-[370px] rounded-[30px] bg-(--surface) flex items-center justify-center px-10 py-12 overflow-hidden max-sm:h-auto max-sm:min-h-[200px] max-sm:px-5 max-sm:py-8 max-sm:rounded-[20px]">
        <div className="flex items-center gap-3 max-sm:flex-wrap" role="group" aria-label="Hero toolbar">
